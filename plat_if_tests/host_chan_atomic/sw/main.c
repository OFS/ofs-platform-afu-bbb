...
help(void)
{
    printf("\n"
           "Usage:\n"
           "    host_chan_atomic [-h] [-B <bus>] [-D <device>] [-F <function>] [-S <socket-id>]\n"
           "\n"
...
//
#define GETOPT_STRING ":hB:D:F:S:v"
static int
...
int main(int argc, char *argv[])
{
    ...
    // Run tests
    int status = testHostChanAtomic(argc, argv, accel_handle, csr_handle, is_ase, verbose);
